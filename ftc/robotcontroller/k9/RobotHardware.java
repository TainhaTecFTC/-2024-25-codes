...
public class RobotHardware {
    ...
    private Servo servo_braco = null;
    ...
    public static final double ROBLOX_ZERO = 0.0;
    public static final double ROBLOX_MIN = 0.0;
    public static final double ROBLOX_MAX = 0.5;
    ...
    public void init() {
        ...
        servoGarra = myOpMode.hardwareMap.get(Servo.class, "servo_garra");
        servo_braco.setPosition(BRACO_ZERO);
        servoGarra.setPosition(GARRA_ZERO);
        ROBLOX.setPosition(ROBLOX_ZERO);
